...
import './Home.css'
import RightBg from '/right_bg_landing_header.svg'
import LeftBg from '/left_bg_landing_header.svg'
import centerBg from '/center_bg_landing_header.svg'
...
export default function Home() {
    return (
        <div>
            <div
                className={`wrapper w-full  bg-[url('${centerBg}')] bg-no-repeat bg-sec-blue bg-cover`}
            >
                <div className="md:container md:mx-auto">
                    <nav className="py-6 px-10 flex justify-between items-center">
                        <div className="brand flex items-center">
                            ...
                            <h1 className="text-white font-main uppercase font-semibold text-lg ml-2">
                                Discord
                            </h1>
                        </div>
                        <div>
                        ...
                        <div className="rounded-full bg-white px-4 py-[7px] flex items-center justify-center">
                            <Link
                                to="/login"
                    ...
                    <div>
                        <img src={LeftBg} alt="left_bg" alt="left-bg" />
                        <img src={RightBg} alt="right_bg" alt="right-bg" />
                    </div>
                </div>
            </div>
        </div>
